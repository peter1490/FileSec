...
//! store is encrypted at rest under the hybrid suite. The window title is
//! suffixed so you can tell which build is running. See `filesec_gui::run`.
...
fn main() -> eframe::Result<()> {
    filesec_gui::run("FileSec (post-quantum)")
}
